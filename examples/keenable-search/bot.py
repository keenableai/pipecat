...
needs current web information, and speaks back a grounded answer.
...
OSS-friendly alternative: swap ``OpenAILLMService`` for ``GroqLLMService``
(Llama 3.3 70B) - see the README in this directory.
"""
...
`keenable_search` tool to look it up on the public web before answering.
